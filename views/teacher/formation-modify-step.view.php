    ...
    <main class="mt-4" id="formation-creation">
        ...
        <div class="d-flex justify-content-center">
          ...
          <?php if(isset($error)) : ?>
            ...
            <?php endif; ?>
            <?php if(isset($allLessons)){ ?>
            <input type="hidden" name="allLesson" value="allLesson" id="allLesson">
            <?php } ?>
            ...
            <?php for($i= 1; $i <= $numberLesson; $i++){ ?>
                ...
                <div class="mb-3">
                    ...
                    <?php if(isset($allLessons)){ ?>
                        <input type="text" class="form-control lessonTitleClass" id="lessonTitle<?= $i ?>" name="lessonTitle[]" value="<?= $_POST['lessonTitle'][$i-1] ?? $allLessons[$i-1]->getTitle() ?>" minlength="2" maxlength="70" required>
                    <?php } else { ?>
                ...
                <div class="mb-3">
                    ...
                    <?php if(isset($allLessons)){ ?>
                        <input type="text" class="form-control lessonVideoClass" id="lessonVideo<?= $i ?>" name="lessonVideo[]" value="<?= $_POST['lessonVideo'][$i-1] ?? $allLessons[$i-1]->getVideo() ?>" minlength="10" maxlength="200" required>
                    <?php } else { ?>
                ...
                <div class="mb-3">
                    ...
                    <?php if(isset($allLessons)){ ?>
                        <textarea class="form-control lessonContentClass" id="lessonContent<?= $i ?>" name="lessonContent[]" value="" cols="30" rows="10" min="50" max="20000" required><?= $_POST['lessonContent'][$i-1] ?? $allLessons[$i-1]->getContent() ?></textarea>
                    <?php } else { ?>
...
$titleHead = 'Modification Formation - étape '.$step;
