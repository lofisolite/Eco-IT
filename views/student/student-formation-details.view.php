...
?>
    ...
    <main>
        ...
        <h2 id="formation-title" class="m-4">Les bonnes pratiques en front-end</h2>
            ...
            <div id="container-formation" class="d-flex justify-content-between">
                <div id="menu-formation">
                    <div id="box-menu-formation">
                        ...
                        <span class="menu-formation-section">Section 1 : les bonnes pratiques en HTML</span>
                        ...
                        <span class="menu-formation-section">Section 2 : Les bonnes pratiques en CSS</span>
                        ...
                        <span class="menu-formation-section">Section 3 : Les bonnes pratiques en JavaScript</span>
                ...
                <div id="box-formation"class="d-flex flex-column align-items-center">
                    ...
                    <div id="formation-box-lesson-statut">
                        <div id="formation-box-lesson-statut-button" class="d-flex flex-column align-items-center">
                            <p class="text-center m-3"><span>Statut de la leçon</span></p>
                            <div class="d-flex justify-content-center">
                                <button class="btn button-general button-type-2">En cours</button>
                                <button class="btn button-general button-type-2">terminé</button>
                            </div>
                        </div>
                    </div>
                </div>
