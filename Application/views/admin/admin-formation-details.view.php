                    ...
                    <div id="formation-box-arrow">
                        ...
                        <div id="formation-button-arrow">
                            <?php if($lessonContent['lessonId'] !== $firstLessonId){ ?>
                                ...
                                <a href="<?= URL ?>adminEspace/formation/<?= $menu['formationId'].'/'.$lessonContent1 ?>" class="btn button-general button-type-1">précédent</a>
                            <?php } ?>
                            
                            <?php if($lessonContent['lessonId'] !== $lastLessonId){ ?>
                                <?php $lessonContent2 = $lessonContent['lessonId'] + 1; ?>
                                <a href="<?= URL ?>adminEspace/formation/<?= $menu['formationId'].'/'.  $lessonContent2 ?>" class="btn button-general button-type-1">Suivant</a>
                            <?php } ?>
                        </div>
                    </div>
