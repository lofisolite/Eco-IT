...
class TeacherManager extends Bdd
{
    ...
    private function addTeacher(Teacher $teacher){
        $this-> allTeachers[] = $teacher;
    }
    ...
    // récupére tous les mails des formateur
    public function getAllTeacherMail(){
        foreach($this->allTeachers as $teacher){
            $teachersMails[] = $teacher->getMail();
        }
